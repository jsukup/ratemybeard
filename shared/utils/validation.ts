 ...
 * Validate rating
 */
export function validateRating(rating: number): ValidationResult<number> {
 ...
 * Validate image ID
 */
export function validateImageId(imageId: string): ValidationResult<string> {
 ...
 */
export function validateReportReason(reason: string): ValidationResult<string> {
...
export function validateSafeString(text: string): ValidationResult<string> {
...
export function validatePagination(params: unknown): ValidationResult<{
  page: number;
  limit: number;
